...
const Test = () => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFileName(files && files[0] ? files[0].name : "No file chosen");
  };

  return (
    <div className="flex-1 max-w-7xl w-full h-[100%] mx-auto px-10 my-5 space-y-4 bg-repeat bg-bg-icons">
      <form className="max-w-lg mx-auto">
        ...
        <label
          htmlFor="user_avatar"
          className="block w-full px-4 py-2 text-sm text-white bg-blue-600 rounded-lg cursor-pointer hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
        >
          Select File
        </label>
      ...
      {/*    Загрузите скриншот с нарушением*/}
      {/*  </div>*/}
      {/*</form>*/}
      {/*<form className="max-w-lg mx-auto">*/}
      ...
      {/*    <label htmlFor="checkbox-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree to*/}
      ...
      {/*           className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>*/}
      {/*    <label htmlFor="checkbox-2" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I want to*/}
      ...
      {/*           className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>*/}
      {/*    <label htmlFor="checkbox-3" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I am 18*/}
      ...
      {/*      <label htmlFor="helper-checkbox" className="font-medium text-gray-900 dark:text-gray-300">Free shipping*/}
      {/*        via*/}
      {/*        Flowbite</label>*/}
      {/*      <p id="helper-checkbox-text" className="text-xs font-normal text-gray-500 dark:text-gray-400">For orders*/}
      ...
      {/*           className="ms-2 text-sm font-medium text-gray-400 dark:text-gray-500">Eligible for international*/}
      {/*      shipping (disabled)</label>*/}
      {/*  </div>*/}
      {/*</fieldset>*/}
      ...
      {/*      <p tabIndex={0}*/}
      {/*         className="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Tasks</p>*/}
      {/*      <div*/}
      ...
      {/*              <p className="text-base font-medium leading-none text-gray-700 mr-2">Marketing Keynote*/}
      {/*                Presentation</p>*/}
      ...
      {/*                  stroke="#52525B"   ></path>*/}
      {/*                <path d="M10 9.1665V9.17484" stroke="#52525B"  */}
      {/*                      ></path>*/}
      {/*                <path d="M6.66669 9.1665V9.17484" stroke="#52525B"  */}
      {/*                      ></path>*/}
      {/*                <path d="M13.3333 9.1665V9.17484" stroke="#52525B"  */}
      {/*                      ></path>*/}
      {/*              </svg>*/}
      ...
      {/*          <td className="pl-5">*/}
      {/*            <button*/}
      {/*              className="py-3 px-3 text-sm focus:outline-none leading-none text-red-700 bg-red-100 rounded">Due*/}
      {/*              today at 18:00*/}
      {/*            </button>*/}
      {/*          </td>*/}
      {/*          <td className="pl-4">*/}
      ...
      {/*                <svg className="dropbtn" xmlns="http://www.w3.org/2000/svg" width="20" height="20"*/}
      ...
      {/*          <td className="pl-5">*/}
      {/*            <button*/}
      {/*              className="py-3 px-6 focus:outline-none text-sm leading-none text-gray-700 bg-gray-100 rounded">Due*/}
      {/*              on 21.02.21*/}
      {/*            </button>*/}
      {/*          </td>*/}
      {/*          <td className="pl-4">*/}
      ...
      {/*          <td className="pl-5">*/}
      {/*            <button*/}
      {/*              className="py-3 px-7 text-sm leading-none text-gray-700 bg-gray-100 rounded focus:outline-none">Due*/}
      {/*              tomorrow*/}
      {/*            </button>*/}
      {/*          </td>*/}
      {/*          <td className="pl-4">*/}
      ...
      {/*          <td className="pl-5">*/}
      {/*            <button*/}
      {/*              className="py-3 px-3 text-sm leading-none text-red-700 bg-red-100 rounded focus:outline-none">Due*/}
      {/*              Today at 18:00*/}
      {/*            </button>*/}
      {/*          </td>*/}
      {/*          <td className="pl-4">*/}
      ...
      {/*          <td className="pl-5">*/}
      {/*            <button*/}
      {/*              className="py-3 px-3 text-sm leading-none text-gray-700 bg-gray-100 hover:bg-gray-200 rounded focus:outline-none">Due*/}
      {/*              Today at 18:00*/}
      {/*            </button>*/}
      {/*          </td>*/}
      {/*          <td className="pl-4">*/}
